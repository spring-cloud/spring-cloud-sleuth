 ...
 */
@SpringBootTest(classes = { TraceWebClientDisabledTests.Config.class }, properties = { "spring.sleuth.web.enabled=true",
		"spring.sleuth.web.client.enabled=false", "spring.sleuth.noop.enabled=true" })
