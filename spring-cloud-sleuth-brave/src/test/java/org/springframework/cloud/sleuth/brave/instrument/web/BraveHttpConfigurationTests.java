...
public class BraveHttpConfigurationTests {
	...
	public void hasNoCycles() {
		contextRunner()
				.withConfiguration(AutoConfigurations.of(TraceAutoConfiguration.class, BraveHttpConfiguration.class))
	...
	private ApplicationContextRunner contextRunner(String... propertyValues) {
		return new ApplicationContextRunner().withPropertyValues(propertyValues).withConfiguration(AutoConfigurations
				.of(TraceAutoConfiguration.class, TraceBraveAutoConfiguration.class, BraveHttpConfiguration.class));
	}
