...
public interface Span {
	 ...
	 * use this, generate the timestamp using
	 */
	 ...
	 * example, if kind is {@link Span.Kind#SERVER} and reported in v1 Zipkin format, the span's start
	...
	enum Kind {
		 ...
		 * duration between {@link #start()} and {@link #finish()} may imply batching delay.
		 *
		 ...
		 * duration between {@link #start()} and {@link #finish()} may imply a processing backlog.
		 *
