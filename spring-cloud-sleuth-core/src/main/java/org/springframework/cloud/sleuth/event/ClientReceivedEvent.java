...
public class ClientReceivedEvent extends ApplicationEvent {
	...
	public String toString() {
		return "org.springframework.cloud.sleuth.event.ClientReceivedEvent(span="
				+ this.span + ")";
	}
	...
	public boolean equals(Object o) {
		if (o == this)
			return true;
		if (!(o instanceof ClientReceivedEvent))
			return false;
		final ClientReceivedEvent other = (ClientReceivedEvent) o;
	...
	protected boolean canEqual(Object other) {
		return other instanceof ClientReceivedEvent;
	}
}