...
public class SpanContinuedEvent extends ApplicationEvent {
	...
	public String toString() {
		return "org.springframework.cloud.sleuth.event.SpanContinuedEvent(span="
				+ this.span + ")";
	}
	...
	public boolean equals(Object o) {
		if (o == this)
			return true;
		if (!(o instanceof SpanContinuedEvent))
			return false;
		final SpanContinuedEvent other = (SpanContinuedEvent) o;
	...
	protected boolean canEqual(Object other) {
		return other instanceof SpanContinuedEvent;
	}
}
