...
class LazyTraceThreadPoolTaskScheduler extends ThreadPoolTaskScheduler {
	...
	public ScheduledFuture<?> schedule(Runnable task, Trigger trigger) {
		return this.delegate.schedule(new TraceRunnable(tracing(), spanNamer(), task), trigger);
	}

	@Override
	public ScheduledFuture<?> schedule(Runnable task, Date startTime) {
		return this.delegate.schedule(new TraceRunnable(tracing(), spanNamer(), task), startTime);
	}

	@Override
	public ScheduledFuture<?> scheduleAtFixedRate(Runnable task, Date startTime, long period) {
		return this.delegate.scheduleAtFixedRate(new TraceRunnable(tracing(), spanNamer(), task), startTime, period);
	}

	@Override
	public ScheduledFuture<?> scheduleAtFixedRate(Runnable task, long period) {
		return this.delegate.scheduleAtFixedRate(new TraceRunnable(tracing(), spanNamer(), task), period);
	}

	@Override
	public ScheduledFuture<?> scheduleWithFixedDelay(Runnable task, Date startTime, long delay) {
		return this.delegate.scheduleWithFixedDelay(new TraceRunnable(tracing(), spanNamer(), task), startTime, delay);
	}

	@Override
	public ScheduledFuture<?> scheduleWithFixedDelay(Runnable task, long delay) {
		return this.delegate.scheduleWithFixedDelay(new TraceRunnable(tracing(), spanNamer(), task), delay);
	}
