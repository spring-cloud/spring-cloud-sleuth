 ...
 * @since 2.1.0
 */
class DefaultTracingChannelInterceptorCustomizer implements TracingChannelInterceptorCustomizer {

	final boolean integrationObjectSupportPresent;

	public DefaultTracingChannelInterceptorCustomizer() {
		this.integrationObjectSupportPresent = ClassUtils.isPresent(
				"org.springframework.integration.context.IntegrationObjectSupport",
				null);
	}

	@Override public void customize(Message<?> message, SpanCustomizer result,
