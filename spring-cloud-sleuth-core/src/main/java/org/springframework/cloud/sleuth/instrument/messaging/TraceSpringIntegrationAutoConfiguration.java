...
public class TraceSpringIntegrationAutoConfiguration {
	...
	public TraceChannelInterceptor traceChannelInterceptor(Tracer tracer,
		...
		return new TraceChannelInterceptor(tracer, traceKeys);
	}

	@Bean
	public SpanJoiner messagingSpanJoiner(Random random) {
		return new MessagingSpanJoiner(random);
	}

	@Bean
	public SpanInjector messagingSpanInjector(TraceKeys traceKeys) {
