...
public class ServerSentEvent extends ApplicationEvent {
	...
	public String toString() {
		return "org.springframework.cloud.sleuth.event.ServerSentEvent(parent="
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof ServerSentEvent))
			return false;
		final ServerSentEvent other = (ServerSentEvent) o;
	...
	protected boolean canEqual(Object other) {
		return other instanceof ServerSentEvent;
	}
}
