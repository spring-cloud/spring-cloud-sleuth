...
public class SamplerAutoConfigurationTests {
	...
	@Test
	public void should_use_CountingSampler_withReporter() {
	...
	@Test
	public void should_use_CountingSampler_withTracingCustomizer() {
	...
	@Test
	public void samplerFromProps_prefersRate() {
		SamplerProperties properties = new SamplerProperties();
		properties.setProbability(0.01f);
