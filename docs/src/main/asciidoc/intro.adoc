...
image:pws.png["Zipkin deployed on Pivotal Web Services", link="http://docssleuth-zipkin-server.cfapps.io/", height=100, width=100]
...
.Click Pivotal Web Service icon to see it live!
[caption="Click Pivotal Web Service icon to see it live!"]
image:pws.png["Zipkin deployed on Pivotal Web Services", link="http://docssleuth-zipkin-server.cfapps.io/dependency", height=100, width=100]
