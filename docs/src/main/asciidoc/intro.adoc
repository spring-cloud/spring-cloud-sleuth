...
[source,java]
----
include::https://raw.githubusercontent.com/spring-cloud/spring-cloud-sleuth/https://raw.githubusercontent.com/spring-cloud/spring-cloud-sleuth/v1.2.4.RELEASE/spring-cloud-sleuth-samples/spring-cloud-sleuth-sample-zipkin-stream/src/main/java/example/ZipkinStreamServerApplication.java[]
----
