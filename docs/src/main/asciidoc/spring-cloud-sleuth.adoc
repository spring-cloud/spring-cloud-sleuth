...
=== Disabling Default Logging Pattern

Spring Cloud Sleuth sets a default logging pattern. To disable it set the `spring.sleuth.default-logging-pattern-enabled` property to `false`.
