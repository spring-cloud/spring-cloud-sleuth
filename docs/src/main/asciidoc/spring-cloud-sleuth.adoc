...
If you want to customize the messaging spans, it's enough to register a bean of type
`org.springframework.cloud.sleuth.instrument.messaging.TracingChannelInterceptorCustomizer` and
apply the customization on the span. You can have multiple such implementations.
