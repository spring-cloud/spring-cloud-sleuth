...
and [Zipkin's list](http://zipkin.io/pages/existing_instrumentations.html)
...
Brave it's required to pass the list of whitelisted baggage keys
via the `spring.sleuth.baggage-keys` property.
