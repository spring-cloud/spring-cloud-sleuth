...
[source,java]
----
include::https://raw.githubusercontent.com/spring-cloud/spring-cloud-build/issues_#79_updating_documentation/spring-cloud-sleuth-core/src/test/java/org/springframework/cloud/sleuth/documentation/SamplingTest.java[tags=always_sampler,indent=0]
----
