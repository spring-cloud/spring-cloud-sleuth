...
IMPORTANT: There are 2 different versions of JDK used in Spring Cloud Sleuth. JDK7 is used for main sources and
JDK8 is used for tests. When importing your project to an IDE please activate the `ide` Maven profile to turn on
JDK8 for both main and test sources. Of course remember that you MUST NOT use JDK8 features in the main sources. If you do
