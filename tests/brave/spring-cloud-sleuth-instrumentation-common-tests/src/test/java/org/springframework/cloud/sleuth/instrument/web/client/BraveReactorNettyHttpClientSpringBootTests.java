...
@SpringBootTest(
		classes = { BraveReactorNettyHttpClientSpringBootTests.Config.class,
				ReactorNettyHttpClientSpringBootTests.TestConfiguration.class },
		webEnvironment = SpringBootTest.WebEnvironment.NONE)
public class BraveReactorNettyHttpClientSpringBootTests extends ReactorNettyHttpClientSpringBootTests {
	...
	static class Config {
		...
		@Bean
		Supplier<TestSpanHandler> testSpanHandlerSupplier(brave.test.IntegrationTestSpanHandler testSpanHandler) {
