...
@SpringBootTest(classes = { SleuthSpanCreatorCircularDependencyTests.Config.class,
		org.springframework.cloud.sleuth.annotation.SleuthSpanCreatorCircularDependencyTests.TestConfiguration.class })
